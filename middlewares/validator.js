...
exports.validateConnection = [
    ...
    body('prodOneLine', 'Product One Liner cannot be empty').notEmpty().trim().escape(),
    body('Significance', 'Significance cannot be empty').notEmpty().trim().escape(),
    body('Cost', 'Cost cannot be empty').notEmpty().trim(),
    body('img_url', 'Image URL cannot be empty').notEmpty.trim()
];
